...
import { Text, View, Alert, StyleSheet , SafeAreaView , Platform , StatusBar , Alert , FlatList, Image, ImageBackground , Dimensions } from 'react-native';
...
<Text style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>altitude - {item.close_approach_data[0].close_approach_date_full}</Text>
<Text style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>threat_score - {item.close_approach_data[0].close_approach_date_full}</Text>
